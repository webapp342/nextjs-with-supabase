...
-- Basit yaklaşım: Doğrudan mevcut verileri kullan
WITH 
intrapharm_data AS (
...
FROM intrapharm_data i, category_data c, user_data u, product_types pt
WHERE pt.slug = 'ferol-capsule' AND pt.brand_id = i.brand_id;
...
FROM intrapharm_data i, category_data c, user_data u, product_types pt
WHERE pt.slug = 'calcium-capsule' AND pt.brand_id = i.brand_id;

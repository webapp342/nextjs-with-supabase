...
import { Package, MapPin, Calendar, Eye, ChevronLeft, ChevronRight, Clock, CheckCircle, Truck, Home, XCircle } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { toPersianNumber } from '@/lib/utils';
import type { SimpleOrder } from '@/lib/simple-orders';

interface SimpleOrderWithItems extends SimpleOrder {
...
interface SimpleAdminOrdersClientProps {
...
export function SimpleAdminOrdersClient({ orders, pagination }: SimpleAdminOrdersClientProps) {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-full"
                      onClick={() => router.push(`/admin/simple-orders/${order.id}`)}
                    >

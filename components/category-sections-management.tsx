...
export function CategorySectionsManagement() {
  ...
  const [formData, setFormData] = useState({
    ...
    text_color: '#000000',
    link_type: 'category' as CategorySection['link_type'],
    link_category_id: '',
    link_brand_id: '',
    link_url: '',
    product_filter_type: 'category' as CategorySection['product_filter_type'],
    filter_category_id: '',
    filter_brand_id: '',
    min_price: undefined as number | undefined,
    max_price: undefined as number | undefined,
    product_limit: 10,
    display_style: 'grid' as CategorySection['display_style'],
    sort_order: 1,
    is_active: true,
    show_on_mobile: true,
